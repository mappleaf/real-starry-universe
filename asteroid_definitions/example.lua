...
ExampleDefinitions.moon-inner = {} -- This shouldn't be empty, but contain about half of the definition between a moon and the moon closer to the planet it orbits. This includes the two planets closer and further from the star the planet this moon orbits as the outermost moons. This only affects moons.
ExampleDefinitions.moon-outer = {} -- This shouldn't be empty, but contain about half of the definition between a moon and the moon further from the planet it orbits. This includes the planet it orbits as the innermost moon. This affects both planets and moons.
